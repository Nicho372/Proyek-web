...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (orderForm) {
        orderForm.addEventListener("submit", function (event) {
            ...
            // 1. Mengambil data nilai (value) dari elemen input form
            ...
            // 2. Logika Percabangan (Switch/Case) untuk menentukan Harga Satuan
            switch (produkKey) {
                case "hot_bev":
            ...
            // 3. Perhitungan Subtotal (Harga dikali jumlah porsi)
            ...
            // 4. Manipulasi DOM untuk mencetak data ke dalam struk pembayaran
